...
We can evaluate our loan application rule as we have the corresponding real values in <tt>`loan_st`</tt>. First, let's illustrate the decision making process given the model estimates. 
