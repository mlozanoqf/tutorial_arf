...
```{r fig.cap = "Full model prediction histogram new cutoff of 0.1994621."}
ggplot(pred_logi[pred_logi$model == "pred_logi_full",], 
       aes(x = pred, fill = model)) + 
  geom_density(alpha = 0.4) +
...
```{r fig.cap = "Full model in red, age model in blue."}
