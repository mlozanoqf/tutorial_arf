...
$\log\left(\frac{p}{1-p}\right) = \beta_0 + \beta_1 \cdot \text{age}$.
...
The estimated model is: $\log\left(\frac{p}{1-p}\right) = -1.90097 - 0.00623 \cdot \text{age}$.

Apparently, there is a negative relationship between age and loan status. 

We can solve for $p$: $p = \frac{\exp(-1.90097 - 0.00623 \cdot \text{age})}{1 + \exp(-1.90097 - 0.00623 \cdot \text{age})}$.

Substituting `age = 18`: $p = \frac{\exp(-1.90097 - 0.00623 \cdot 18)}{1 + \exp(-1.90097 - 0.00623 \cdot 18)}$,

$p = \frac{\exp(-2.01311)}{1 + \exp(-2.01311)} \approx \frac{0.1333}{1 + 0.1333} = \frac{0.1333}{1.1333} \approx 0.1176$.


Substituting `age = 60`: $p = \frac{\exp(-1.90097 - 0.00623 \cdot 60)}{1 + \exp(-1.90097 - 0.00623 \cdot 60)}$,

$p = \frac{\exp(-2.27477)}{1 + \exp(-2.27477)} \approx \frac{0.1037}{1 + 0.1037} = \frac{0.1037}{1.1037} \approx 0.0939$.
...
```{r}
#| label: fig-fmpaco
#| fig-cap: "Full model predictions and cut-off."
...
```{r}
#| label: fig-fmphaco
#| fig-cap: "Full model predictions histogram and cut-off."
