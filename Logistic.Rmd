...
The @fig-fmibamio has a full range of acceptance rates. Let's evaluate the values of sensitivity and specificity at two acceptance rates that we have reviewed before: 65% and 80%.
...
```{r Confusion matrix pred_full_20a}
# Calculate the predictions with the same model and new cutoff.
...
```{r Confusion matrix pred_full_35a}
# Calculate the predictions with the same model and new cutoff.
