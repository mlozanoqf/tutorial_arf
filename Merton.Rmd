...
Nd2 <- pnorm(d2)
Nd2neg <- pnorm(-d2)
ans <- data.frame(d1, Nd1, d2, Nd2, Nd2neg)
kable(ans, caption = "Inspect the role of d and N(d).")
```
...
The minimization conducted in the function <tt>`min.footnote10`</tt> above worked fairly well.
