...
paste0("pd(5years)=", fmt_pct(pd[5], 0), "

The left green area
represents ", fmt_pct(pd[5], 0), " of the
whole bell-shape.

N^-1(", fmt_num(pd[5], 2), ")=", fmt_num(x.y[5], 6), "
N(", fmt_num(x.y[5], 6), ")=", fmt_num(pnorm(x.y[5]), 2))),
...
lines(rep(x.y[5], 2), seq(0, pnorm(x.y[5]), length.out = 2), 
      col = "green", lwd = 3)
points(x.y[5], pd[5], pch = 19, col = "green", cex = 2)
...
lines(rep(x.y[5], 2), seq(0, pnorm(x.y[5]), length.out = 2), 
      col = "green", lwd = 3, lty = 2)
points(x.y[3], pd[3], pch = 19, col = "purple", cex = 2)
points(x.y[5], pd[5], pch = 19, col = "green", cex = 2)
legend("topleft", legend=c(
  paste0("pd(5years)=", fmt_pct(pd[5], 0), ": N(",
         fmt_num(x.y[5], 6), ")=", fmt_num(pnorm(x.y[5]), 2)),
  paste0("pd(3years)=", fmt_pct(pd[3], 0), ": N(",
         fmt_num(x.y[3], 6), ")=", fmt_num(pnorm(x.y[3]), 2))),
