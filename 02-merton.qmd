...
```{r load libraries Merton., include=FALSE}
library(knitr)
library(plotly)
...
#| fig-cap: "The probability of default as a function of the equity at time zero."
...
#| fig-cap: "The probability of default as a function of the risk-free rate."
...
#| fig-cap: "The probability of default as a function of the debt."
...
#| fig-cap: "The probability of default as a function of the debt's maturity."
...
#| fig-cap: "The probability of default as a function of the volatility of the equity."
...
#| fig-cap: "The probability of default as a function of the equity at time zero and the volatility of equity."
...
#| fig-cap: "The probability of default as a function of the equity at time zero and the volatility of equity: A plane or surface view."
# Plot results.
...
#| fig-cap: "The probability of default as a function of the equity at time zero and the volatility of equity: A contour view."
...
#| fig-cap: "The probability of default as a function of the equity at time zero and the volatility of equity: An interactive view."
...
```{r}
#| label: fig-gppodacs
#| fig-cap: "GoT problem. Probability of default and capital structure."
...
```{r}
#| label: fig-gspodacs
#| fig-cap: "GoT solution. Probability of default and capital structure."
plot(D.seq, E1, type = "l", col = "green", lwd = 3,
     xlab = "Debt value. Initially, D=10",
     ylab = "Probability of default. Initially PD=12.69%")
lines(D.seq, E2, col = "purple", lwd = 3)
...
```{r}
#| label: fig-gp2podacs
#| fig-cap: "GoT problem 2. Probability of default and capital structure."
...
```{r}
#| label: fig-gs2podacs
#| fig-cap: "GoT solution 2. Probability of default and capital structure."
plot(D.seq, E1, type = "l", col = "green", lwd = 3,
     xlab = "Debt value. Initially, D=2",
     ylab = "Probability of default. Initially PD=7.13%", 
     xlim = c(0, 2.5), ylim = c(0, 0.08))
