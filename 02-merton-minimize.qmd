...
The estimation of the credit-risk Merton model requires minimizing a function. In this section, we show a simple minimization example. Here are some useful online resources for further references.
...
The minimization result is represented by a line, and the line is characterized by an intercept equal to $`r fmt_num(a, 6)`$ and a slope equal to $`r fmt_num(b, 5)`$. 
